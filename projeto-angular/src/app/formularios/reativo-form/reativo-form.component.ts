...
export class ReativoFormComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.meuForm = this.formBuilder.group({
      email : [ null, [ Validators.required, Validators.email ] ],//HA UM CAMPO HTML COM UM VALIDADOR//PRENCHIMENTO OBRIGATORIO
      password : [ null, [ Validators.required ] ] //HA UM CAMPO HTML COM UM VALIDADOR//PRENCHIMENTO OBRIGATORIO
    });
